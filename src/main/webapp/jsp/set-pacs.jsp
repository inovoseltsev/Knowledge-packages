...
<head>
    ...
    <link rel="stylesheet"
          ...
          type="text/css">
    <link rel="stylesheet"
          href="<c:url value="/resources/css/pacs-set.css"/>"
          type="text/css">
</head>
<body>
<header>
...
<div class="table-container">
    <h1>Knowledge packages set</h1>
    <table class="dhtmlxGrid table table-bordered" id="k_pac_k_pac_set_table">
        <thead>
        <tr>
            <th>Id</th>
            <th>Title</th>
        ...
        <tbody>
        <c:forEach var="kpack" items="${kpacs}">
            <tr class="table-row">
                <td>${kpack.getId()}</td>
                <td>${kpack.getTitle()}</td>
                <td><a
                        href="/kpacs/${kpack.getId()}/deletion-from/set/${setId}">
                    <button
...
<div class="modal fade" id="modal-form" tabindex="-1" role="dialog"
    ...
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            ...
            <form name="meForm" id="changeForm" action="/kpacs/set/${setId}"
                  method="post">
...
<script src="${pageContext.request.contextPath}/resources/js/script.js"
        type="text/javascript"></script>
<script src="${pageContext.request.contextPath}/resources/js/set-of-pacs-table-config.js"
        type="text/javascript"></script>
</body>
</html>
